...
class Neo4j():
    ...
    def connectDB(self):
        # self.graph = Graph("bolt://127.0.0.1:7687", auth=("neo4j", "1234567890"))
        self.graph = Graph("bolt://127.0.0.1:7687", name="agriculture", auth=("neo4j", "Lzx19960802"))
    ...
    def getEntityRelationbyEntity(self, value):
        sql = "MATCH (entity1) - [rel] -> (entity2)  WHERE entity1.title = \"" + str(
