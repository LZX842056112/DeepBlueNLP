...
async def api_generate_stream(request: Request):
    ...
    logger.info(f"Worker进程中的worker_generate_stream方法: {request} - {params}")
    print(f"Worker进程中的worker_generate_stream方法: {request} - {params}")
...
async def api_generate(request: Request):
    print(f"Worker进程中的api_generate方法: {request}")
    logger.info(f"Worker进程中的api_generate方法: {request}")
    params = await request.json()
    await acquire_worker_semaphore()
