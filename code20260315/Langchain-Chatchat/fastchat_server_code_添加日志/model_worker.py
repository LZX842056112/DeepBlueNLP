...
class ModelWorker(BaseModelWorker):
    def __init__(
        ...
        **kwargs,
        ...
        logger.info(f"Load LLM model worker {self.model} {worker_id} {self.generate_stream_func}")
    ...
    def generate_stream_gate(self, params):
        print(f"本地LLM Worker进程 Worker Object 方法调用 generate_stream_gate \n{params}\n")
        logger.info(f"本地LLM Worker进程 Worker Object 方法调用 generate_stream_gate \n{params}\n")
        if self.device == "npu":
            import torch_npu
    ...
    def generate_gate(self, params):
        print(f"本地LLM Worker进程 Worker Object 方法调用 generate_gate \n{params}\n")
        logger.info(f"本地LLM Worker进程 Worker Object 方法调用 generate_gate \n{params}\n")
