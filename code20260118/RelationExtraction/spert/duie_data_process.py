...
input_root = r"data\datasets\DuIE2.0\duie2.0_original"
output_root = r"data\datasets\DuIE2.0\duie2.0"
is_small = True
...
def get_types():
    entity_types = set()  # 保存实体类别
    relation_types = set()  # 保存关系类型
...
def get_conell04_data(in_path, out_path):
    ...
    for d in tqdm(data, ncols=100):
        ...
        for spo in spo_list:
            ...
            if "人物" in sbj_type:
                sbj_type = "人物"
            sbj = spo["subject"]  # 主体span子字符串
            obj = spo["object"]["@value"]  # 客体span子字符串
